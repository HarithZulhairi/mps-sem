    ...
    <div class="profile-picture">
        ...
        <form method="post" action="{{ route('profile.mentor.update') }}">
            ...
            <div class="form-group">
                ...
                <p class="form-control-static" style="display: inline; margin-left: 10px;">{{ $mentor->M_name }}</p>
            </div>
            <div class="form-group">
                <h6 style="display: inline;">IC Number: <span style="color: red;"></span></h6>
                <p class="form-control-static" style="display: inline; margin-left: 10px;">{{ $mentor->M_IC }}</p>
            </div>
            <div class="form-group">
                <h6 style="display: inline;">Gender: <span style="color: red;"></span></h6>
                <p class="form-control-static" style="display: inline; margin-left: 10px;">{{ $mentor->M_gender }}</p>
            </div>
            <div class="form-group">
                <h6 style="display: inline;">Email: <span style="color: red;"></span></h6>
                <p class="form-control-static" style="display: inline; margin-left: 10px;">{{ $mentor->M_email }}</p>
            </div>
            <div class="form-group">
                <h6 style="display: inline;">Phone Number: <span style="color: red;"></span></h6>
                <p class="form-control-static" style="display: inline; margin-left: 10px;">{{ $mentor->M_phoneNum }}</p>
            </div>
            <div class="form-group">
