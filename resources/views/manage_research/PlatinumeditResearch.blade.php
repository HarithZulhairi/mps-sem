...
@php
    // ✅ Option A: Parse existing timeline string "YYYY-MM-DD to YYYY-MM-DD"
    $startDate = '';
    $endDate = '';

    if (!empty($data->RI_timeline) && str_contains($data->RI_timeline, ' to ')) {
        [$startDate, $endDate] = explode(' to ', $data->RI_timeline, 2);
        ...
        <form method="post" action="{{ url('platinum/research/updateResearch') }}">
            ...
            <div class="details-grid">
                ...
                <div class="detail-row full">
                    ...
                    <input type="text" id="title" name="RI_title" class="detail-input"
                           placeholder="Enter your title here"
                           value="{{ $data->RI_title }}" required>
                </div>

                <div class="detail-row full">
                    <div class="detail-label">Abstract <span class="required-star">*</span></div>
                    <input type="text" id="abstract" name="RI_abstract" class="detail-input"
                           placeholder="Enter your abstract"
                           value="{{ $data->RI_abstract }}" required>
                </div>

                <div class="detail-row">
                    <div class="detail-label">Research Area <span class="required-star">*</span></div>
                    <input type="text" id="area" name="RI_area" class="detail-input"
                           placeholder="Enter your research area here"
                           value="{{ $data->RI_area }}" required>
                </div>

                <div class="detail-row">
                    <div class="detail-label">Budget <span class="required-star">*</span></div>
                    <input type="text" id="budget" name="RI_budget" class="detail-input"
                           placeholder="Enter your budget here"
                           value="{{ $data->RI_budget }}" required>
                </div>

                <div class="detail-row full">
                    <div class="detail-label">Objective <span class="required-star">*</span></div>
                    <input type="text" id="objective" name="RI_objective" class="detail-input"
                           placeholder="Enter your objective here"
                           value="{{ $data->RI_objective }}" required>
                </div>

                <div class="detail-row full">
                    <div class="detail-label">Methodology <span class="required-star">*</span></div>
                    <input type="text" id="method" name="RI_methodology" class="detail-input"
                           placeholder="Enter your methodology here"
                           value="{{ $data->RI_methodology }}" required>
                </div>

                <div class="detail-row full">
                    <div class="detail-label">Research Background <span class="required-star">*</span></div>
                    <input type="text" id="background" name="RI_background" class="detail-input"
                           placeholder="Enter your research background here"
                           value="{{ $data->RI_background }}" required>
                </div>

                <div class="detail-row">
                    <div class="detail-label">Start Date <span class="required-star">*</span></div>
                    <input type="date" id="start_date" name="start_date" class="detail-input"
                           value="{{ $startDate }}" required>
                </div>

                <div class="detail-row">
                    <div class="detail-label">Expected End Date <span class="required-star">*</span></div>
                    <input type="date" id="end_date" name="end_date" class="detail-input"
